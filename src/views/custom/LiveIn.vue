<template>
    <div class="livein">
        ...
        <el-table :data="list" style="width: 100%">
            ...
            <el-table-column prop="room.roomType.roomTypeName" label="房型" width="100"> </el-table-column>
            <el-table-column prop="roomId" label="房间号" width="100" />
            <el-table-column prop="resideState.resideStateName" label="状态" width="100" />
            <el-table-column prop="resideDate" label="入住日期" width="100" />
            <el-table-column prop="leaveDate" label="离开日期" width="100" />
            <el-table-column prop="deposit" label="押金" width="100" />
            <el-table-column prop="guestNum" label="入住人数" width="100" />
        ...
        <EditCutom ref="editRef" @sync-list="loadList"></EditCutom>
    </div>
</template>

<script setup lang="ts">
    import EditCutom from "../../components/custom/EditCutom.vue"
    import { onMounted, ref} from 'vue'
    import {$list,$getOne,$delete} from '../../api/guest.ts'
